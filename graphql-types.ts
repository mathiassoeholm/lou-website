...
export type DatoCmsAbout = Node & {
  ...
  _allTitleLocales?: Maybe<Array<Maybe<DatoCmsAllLocalesForDatoCmsAboutTitle>>>;
  content?: Maybe<Scalars['String']>;
  contentNode?: Maybe<DatoCmsTextNode>;
  _allContentLocales?: Maybe<Array<Maybe<DatoCmsAllLocalesForDatoCmsAboutContent>>>;
  image?: Maybe<DatoCmsFileField>;
  _allImageLocales?: Maybe<Array<Maybe<DatoCmsAllLocalesForDatoCmsAboutImage>>>;
...
export type DatoCmsAboutFieldsEnum = 
  'title' |
  '_allTitleLocales' |
  ...
  'image___customData' |
  '_allImageLocales' |
  '_allImageLocales___locale' |
  '_allImageLocales___value___size' |
  '_allImageLocales___value___width' |
  '_allImageLocales___value___height' |
  '_allImageLocales___value___path' |
  '_allImageLocales___value___format' |
  '_allImageLocales___value___isImage' |
  '_allImageLocales___value___createdAt' |
  '_allImageLocales___value___url' |
  '_allImageLocales___value___notes' |
  '_allImageLocales___value___author' |
  '_allImageLocales___value___copyright' |
  '_allImageLocales___value___originalId' |
  '_allImageLocales___value___tags' |
  '_allImageLocales___value___smartTags' |
  '_allImageLocales___value___filename' |
  '_allImageLocales___value___basename' |
  '_allImageLocales___value___exifInfo' |
  '_allImageLocales___value___mimeType' |
  '_allImageLocales___value___colors' |
  '_allImageLocales___value___colors___red' |
  '_allImageLocales___value___colors___green' |
  '_allImageLocales___value___colors___blue' |
  '_allImageLocales___value___colors___alpha' |
  '_allImageLocales___value___colors___rgb' |
  '_allImageLocales___value___colors___hex' |
  '_allImageLocales___value___blurhash' |
  '_allImageLocales___value___video___muxPlaybackId' |
  '_allImageLocales___value___video___frameRate' |
  '_allImageLocales___value___video___duration' |
  '_allImageLocales___value___video___streamingUrl' |
  '_allImageLocales___value___video___thumbnailUrl' |
  '_allImageLocales___value___video___mp4Url' |
  '_allImageLocales___value___fluid___base64' |
  '_allImageLocales___value___fluid___tracedSVG' |
  '_allImageLocales___value___fluid___aspectRatio' |
  '_allImageLocales___value___fluid___width' |
  '_allImageLocales___value___fluid___height' |
  '_allImageLocales___value___fluid___src' |
  '_allImageLocales___value___fluid___srcSet' |
  '_allImageLocales___value___fluid___sizes' |
  '_allImageLocales___value___sizes___base64' |
  '_allImageLocales___value___sizes___tracedSVG' |
  '_allImageLocales___value___sizes___aspectRatio' |
  '_allImageLocales___value___sizes___width' |
  '_allImageLocales___value___sizes___height' |
  '_allImageLocales___value___sizes___src' |
  '_allImageLocales___value___sizes___srcSet' |
  '_allImageLocales___value___sizes___sizes' |
  '_allImageLocales___value___fixed___base64' |
  '_allImageLocales___value___fixed___tracedSVG' |
  '_allImageLocales___value___fixed___aspectRatio' |
  '_allImageLocales___value___fixed___width' |
  '_allImageLocales___value___fixed___height' |
  '_allImageLocales___value___fixed___src' |
  '_allImageLocales___value___fixed___srcSet' |
  '_allImageLocales___value___fixed___sizes' |
  '_allImageLocales___value___resolutions___base64' |
  '_allImageLocales___value___resolutions___tracedSVG' |
  '_allImageLocales___value___resolutions___aspectRatio' |
  '_allImageLocales___value___resolutions___width' |
  '_allImageLocales___value___resolutions___height' |
  '_allImageLocales___value___resolutions___src' |
  '_allImageLocales___value___resolutions___srcSet' |
  '_allImageLocales___value___resolutions___sizes' |
  '_allImageLocales___value___alt' |
  '_allImageLocales___value___title' |
  '_allImageLocales___value___customData' |
  'meta___createdAt' |
  'meta___updatedAt' |
  'meta___publishedAt' |
...
export type DatoCmsAboutFilterInput = {
  ...
  _allTitleLocales?: Maybe<DatoCmsAllLocalesForDatoCmsAboutTitleFilterListInput>;
  content?: Maybe<StringQueryOperatorInput>;
  contentNode?: Maybe<DatoCmsTextNodeFilterInput>;
  _allContentLocales?: Maybe<DatoCmsAllLocalesForDatoCmsAboutContentFilterListInput>;
  image?: Maybe<DatoCmsFileFieldFilterInput>;
  _allImageLocales?: Maybe<DatoCmsAllLocalesForDatoCmsAboutImageFilterListInput>;
...
export type DatoCmsAllLocalesForDatoCmsAboutContent = {
  locale?: Maybe<Scalars['String']>;
  value?: Maybe<Scalars['String']>;
  valueNode?: Maybe<DatoCmsTextNode>;
};

export type DatoCmsAllLocalesForDatoCmsAboutContentFilterInput = {
  locale?: Maybe<StringQueryOperatorInput>;
  value?: Maybe<StringQueryOperatorInput>;
  valueNode?: Maybe<DatoCmsTextNodeFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsAboutContentFilterListInput = {
  elemMatch?: Maybe<DatoCmsAllLocalesForDatoCmsAboutContentFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsAboutImage = {
  locale?: Maybe<Scalars['String']>;
  value?: Maybe<DatoCmsFileField>;
};

export type DatoCmsAllLocalesForDatoCmsAboutImageFilterInput = {
  locale?: Maybe<StringQueryOperatorInput>;
  value?: Maybe<DatoCmsFileFieldFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsAboutImageFilterListInput = {
  elemMatch?: Maybe<DatoCmsAllLocalesForDatoCmsAboutImageFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsAboutTitle = {
  locale?: Maybe<Scalars['String']>;
  value?: Maybe<Scalars['String']>;
};

export type DatoCmsAllLocalesForDatoCmsAboutTitleFilterInput = {
  locale?: Maybe<StringQueryOperatorInput>;
  value?: Maybe<StringQueryOperatorInput>;
};

export type DatoCmsAllLocalesForDatoCmsAboutTitleFilterListInput = {
  elemMatch?: Maybe<DatoCmsAllLocalesForDatoCmsAboutTitleFilterInput>;
};
...
export type DatoCmsAllLocalesForDatoCmsBlogHeader = {
  locale?: Maybe<Scalars['String']>;
  value?: Maybe<Scalars['String']>;
};

export type DatoCmsAllLocalesForDatoCmsBlogHeaderFilterInput = {
  locale?: Maybe<StringQueryOperatorInput>;
  value?: Maybe<StringQueryOperatorInput>;
};

export type DatoCmsAllLocalesForDatoCmsBlogHeaderFilterListInput = {
  elemMatch?: Maybe<DatoCmsAllLocalesForDatoCmsBlogHeaderFilterInput>;
};
...
export type DatoCmsAllLocalesForDatoCmsHomeWelcomeTextFilterInput = {
  locale?: Maybe<StringQueryOperatorInput>;
  value?: Maybe<StringQueryOperatorInput>;
  valueNode?: Maybe<DatoCmsTextNodeFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsHomeWelcomeTextFilterListInput = {
  elemMatch?: Maybe<DatoCmsAllLocalesForDatoCmsHomeWelcomeTextFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceAuthor = {
  locale?: Maybe<Scalars['String']>;
  value?: Maybe<Scalars['String']>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceAuthorFilterInput = {
  locale?: Maybe<StringQueryOperatorInput>;
  value?: Maybe<StringQueryOperatorInput>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceAuthorFilterListInput = {
  elemMatch?: Maybe<DatoCmsAllLocalesForDatoCmsReferenceAuthorFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceCompany = {
  locale?: Maybe<Scalars['String']>;
  value?: Maybe<Scalars['String']>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceCompanyFilterInput = {
  locale?: Maybe<StringQueryOperatorInput>;
  value?: Maybe<StringQueryOperatorInput>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceCompanyFilterListInput = {
  elemMatch?: Maybe<DatoCmsAllLocalesForDatoCmsReferenceCompanyFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceText = {
  locale?: Maybe<Scalars['String']>;
  value?: Maybe<Scalars['String']>;
  valueNode?: Maybe<DatoCmsTextNode>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceTextFilterInput = {
  locale?: Maybe<StringQueryOperatorInput>;
  value?: Maybe<StringQueryOperatorInput>;
  valueNode?: Maybe<DatoCmsTextNodeFilterInput>;
};

export type DatoCmsAllLocalesForDatoCmsReferenceTextFilterListInput = {
  elemMatch?: Maybe<DatoCmsAllLocalesForDatoCmsReferenceTextFilterInput>;
};
...
export type DatoCmsBlog = Node & {
  header?: Maybe<Scalars['String']>;
  _allHeaderLocales?: Maybe<Array<Maybe<DatoCmsAllLocalesForDatoCmsBlogHeader>>>;
  meta?: Maybe<DatoCmsMetaField>;
  originalId?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
  seoMetaTags?: Maybe<DatoCmsSeoMetaTags>;
...
export type DatoCmsBlogConnection = {
  totalCount: Scalars['Int'];
  edges: Array<DatoCmsBlogEdge>;
  nodes: Array<DatoCmsBlog>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<DatoCmsBlogGroupConnection>;
};


export type DatoCmsBlogConnectionDistinctArgs = {
  field: DatoCmsBlogFieldsEnum;
};


export type DatoCmsBlogConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: DatoCmsBlogFieldsEnum;
};

export type DatoCmsBlogEdge = {
  next?: Maybe<DatoCmsBlog>;
  node: DatoCmsBlog;
  previous?: Maybe<DatoCmsBlog>;
};

export type DatoCmsBlogFieldsEnum = 
  'header' |
  '_allHeaderLocales' |
  '_allHeaderLocales___locale' |
  '_allHeaderLocales___value' |
  'meta___createdAt' |
  'meta___updatedAt' |
  'meta___publishedAt' |
  'meta___firstPublishedAt' |
...
export type DatoCmsBlogFilterInput = {
  header?: Maybe<StringQueryOperatorInput>;
  _allHeaderLocales?: Maybe<DatoCmsAllLocalesForDatoCmsBlogHeaderFilterListInput>;
  meta?: Maybe<DatoCmsMetaFieldFilterInput>;
  originalId?: Maybe<StringQueryOperatorInput>;
  locale?: Maybe<StringQueryOperatorInput>;
  seoMetaTags?: Maybe<DatoCmsSeoMetaTagsFilterInput>;
...
export type DatoCmsBlogGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<DatoCmsBlogEdge>;
  nodes: Array<DatoCmsBlog>;
  pageInfo: PageInfo;
...
export type DatoCmsBlogSortInput = {
  fields?: Maybe<Array<Maybe<DatoCmsBlogFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type DatoCmsHomeFieldsEnum = 
  ...
  'portrait___format' |
  'portrait___isImage' |
  'portrait___createdAt' |
  'portrait___url' |
  'portrait___notes' |
  'portrait___author' |
  'portrait___copyright' |
  'portrait___originalId' |
  'portrait___tags' |
  'portrait___smartTags' |
  'portrait___filename' |
  'portrait___basename' |
  'portrait___exifInfo' |
  'portrait___mimeType' |
  'portrait___colors' |
  'portrait___colors___red' |
  'portrait___colors___green' |
  'portrait___colors___blue' |
  'portrait___colors___alpha' |
  'portrait___colors___rgb' |
  'portrait___colors___hex' |
  'portrait___blurhash' |
  'portrait___video___muxPlaybackId' |
  'portrait___video___frameRate' |
  'portrait___video___duration' |
  'portrait___video___streamingUrl' |
  'portrait___video___thumbnailUrl' |
  'portrait___video___mp4Url' |
  'portrait___fluid___base64' |
  'portrait___fluid___tracedSVG' |
  'portrait___fluid___aspectRatio' |
  'portrait___fluid___width' |
  'portrait___fluid___height' |
  'portrait___fluid___src' |
  'portrait___fluid___srcSet' |
  'portrait___fluid___sizes' |
  'portrait___sizes___base64' |
  'portrait___sizes___tracedSVG' |
  'portrait___sizes___aspectRatio' |
  'portrait___sizes___width' |
  'portrait___sizes___height' |
  'portrait___sizes___src' |
  'portrait___sizes___srcSet' |
  'portrait___sizes___sizes' |
  'portrait___fixed___base64' |
  'portrait___fixed___tracedSVG' |
  'portrait___fixed___aspectRatio' |
  'portrait___fixed___width' |
  'portrait___fixed___height' |
  'portrait___fixed___src' |
  'portrait___fixed___srcSet' |
  'portrait___fixed___sizes' |
  'portrait___resolutions___base64' |
  'portrait___resolutions___tracedSVG' |
  'portrait___resolutions___aspectRatio' |
  'portrait___resolutions___width' |
  'portrait___resolutions___height' |
  'portrait___resolutions___src' |
  'portrait___resolutions___srcSet' |
  'portrait___resolutions___sizes' |
  'portrait___alt' |
  'portrait___title' |
  'portrait___customData' |
  'welcomeText' |
  'welcomeTextNode___id' |
  'welcomeTextNode___parent___id' |
  'welcomeTextNode___parent___parent___id' |
  'welcomeTextNode___parent___parent___children' |
  'welcomeTextNode___parent___children' |
  'welcomeTextNode___parent___children___id' |
  'welcomeTextNode___parent___children___children' |
  'welcomeTextNode___parent___internal___content' |
  'welcomeTextNode___parent___internal___contentDigest' |
  'welcomeTextNode___parent___internal___description' |
  'welcomeTextNode___parent___internal___fieldOwners' |
  'welcomeTextNode___parent___internal___ignoreType' |
  'welcomeTextNode___parent___internal___mediaType' |
  'welcomeTextNode___parent___internal___owner' |
  'welcomeTextNode___parent___internal___type' |
  'welcomeTextNode___children' |
  'welcomeTextNode___children___id' |
  'welcomeTextNode___children___parent___id' |
  'welcomeTextNode___children___parent___children' |
  'welcomeTextNode___children___children' |
  'welcomeTextNode___children___children___id' |
  'welcomeTextNode___children___children___children' |
  'welcomeTextNode___children___internal___content' |
  'welcomeTextNode___children___internal___contentDigest' |
  'welcomeTextNode___children___internal___description' |
  'welcomeTextNode___children___internal___fieldOwners' |
  'welcomeTextNode___children___internal___ignoreType' |
  'welcomeTextNode___children___internal___mediaType' |
  'welcomeTextNode___children___internal___owner' |
  'welcomeTextNode___children___internal___type' |
  'welcomeTextNode___internal___content' |
  'welcomeTextNode___internal___contentDigest' |
  'welcomeTextNode___internal___description' |
  'welcomeTextNode___internal___fieldOwners' |
  'welcomeTextNode___internal___ignoreType' |
  'welcomeTextNode___internal___mediaType' |
  'welcomeTextNode___internal___owner' |
  'welcomeTextNode___internal___type' |
  'welcomeTextNode___childMarkdownRemark___id' |
  'welcomeTextNode___childMarkdownRemark___frontmatter___title' |
  'welcomeTextNode___childMarkdownRemark___excerpt' |
  'welcomeTextNode___childMarkdownRemark___rawMarkdownBody' |
  'welcomeTextNode___childMarkdownRemark___html' |
  'welcomeTextNode___childMarkdownRemark___htmlAst' |
  'welcomeTextNode___childMarkdownRemark___excerptAst' |
  'welcomeTextNode___childMarkdownRemark___headings' |
  'welcomeTextNode___childMarkdownRemark___headings___value' |
  'welcomeTextNode___childMarkdownRemark___headings___depth' |
  'welcomeTextNode___childMarkdownRemark___timeToRead' |
  'welcomeTextNode___childMarkdownRemark___tableOfContents' |
  'welcomeTextNode___childMarkdownRemark___wordCount___paragraphs' |
  'welcomeTextNode___childMarkdownRemark___wordCount___sentences' |
  'welcomeTextNode___childMarkdownRemark___wordCount___words' |
  'welcomeTextNode___childMarkdownRemark___parent___id' |
  'welcomeTextNode___childMarkdownRemark___parent___children' |
  'welcomeTextNode___childMarkdownRemark___children' |
  'welcomeTextNode___childMarkdownRemark___children___id' |
  'welcomeTextNode___childMarkdownRemark___children___children' |
  'welcomeTextNode___childMarkdownRemark___internal___content' |
  'welcomeTextNode___childMarkdownRemark___internal___contentDigest' |
  'welcomeTextNode___childMarkdownRemark___internal___description' |
  'welcomeTextNode___childMarkdownRemark___internal___fieldOwners' |
  'welcomeTextNode___childMarkdownRemark___internal___ignoreType' |
  'welcomeTextNode___childMarkdownRemark___internal___mediaType' |
  'welcomeTextNode___childMarkdownRemark___internal___owner' |
  'welcomeTextNode___childMarkdownRemark___internal___type' |
  '_allWelcomeTextLocales' |
  '_allWelcomeTextLocales___locale' |
  '_allWelcomeTextLocales___value' |
  '_allWelcomeTextLocales___valueNode___id' |
  '_allWelcomeTextLocales___valueNode___parent___id' |
  '_allWelcomeTextLocales___valueNode___parent___children' |
  '_allWelcomeTextLocales___valueNode___children' |
  '_allWelcomeTextLocales___valueNode___children___id' |
  '_allWelcomeTextLocales___valueNode___children___children' |
  '_allWelcomeTextLocales___valueNode___internal___content' |
  '_allWelcomeTextLocales___valueNode___internal___contentDigest' |
  '_allWelcomeTextLocales___valueNode___internal___description' |
  '_allWelcomeTextLocales___valueNode___internal___fieldOwners' |
  '_allWelcomeTextLocales___valueNode___internal___ignoreType' |
  '_allWelcomeTextLocales___valueNode___internal___mediaType' |
  '_allWelcomeTextLocales___valueNode___internal___owner' |
  '_allWelcomeTextLocales___valueNode___internal___type' |
  '_allWelcomeTextLocales___valueNode___childMarkdownRemark___id' |
  '_allWelcomeTextLocales___valueNode___childMarkdownRemark___excerpt' |
  '_allWelcomeTextLocales___valueNode___childMarkdownRemark___rawMarkdownBody' |
  '_allWelcomeTextLocales___valueNode___childMarkdownRemark___html' |
  '_allWelcomeTextLocales___valueNode___childMarkdownRemark___htmlAst' |
  '_allWelcomeTextLocales___valueNode___childMarkdownRemark___excerptAst' |
  '_allWelcomeTextLocales___valueNode___childMarkdownRemark___headings' |
...
export type DatoCmsReference = Node & {
  text?: Maybe<Scalars['String']>;
  textNode?: Maybe<DatoCmsTextNode>;
  _allTextLocales?: Maybe<Array<Maybe<DatoCmsAllLocalesForDatoCmsReferenceText>>>;
  author?: Maybe<Scalars['String']>;
  _allAuthorLocales?: Maybe<Array<Maybe<DatoCmsAllLocalesForDatoCmsReferenceAuthor>>>;
  company?: Maybe<Scalars['String']>;
  _allCompanyLocales?: Maybe<Array<Maybe<DatoCmsAllLocalesForDatoCmsReferenceCompany>>>;
  position?: Maybe<Scalars['Int']>;
  meta?: Maybe<DatoCmsMetaField>;
  originalId?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type DatoCmsReferenceConnection = {
  totalCount: Scalars['Int'];
  edges: Array<DatoCmsReferenceEdge>;
  nodes: Array<DatoCmsReference>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<DatoCmsReferenceGroupConnection>;
};


export type DatoCmsReferenceConnectionDistinctArgs = {
  field: DatoCmsReferenceFieldsEnum;
};


export type DatoCmsReferenceConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: DatoCmsReferenceFieldsEnum;
};

export type DatoCmsReferenceEdge = {
  next?: Maybe<DatoCmsReference>;
  node: DatoCmsReference;
  previous?: Maybe<DatoCmsReference>;
};

export type DatoCmsReferenceFieldsEnum = 
  'text' |
  'textNode___id' |
  'textNode___parent___id' |
  'textNode___parent___parent___id' |
  'textNode___parent___parent___children' |
  'textNode___parent___children' |
  'textNode___parent___children___id' |
  'textNode___parent___children___children' |
  'textNode___parent___internal___content' |
  'textNode___parent___internal___contentDigest' |
  'textNode___parent___internal___description' |
  'textNode___parent___internal___fieldOwners' |
  'textNode___parent___internal___ignoreType' |
  'textNode___parent___internal___mediaType' |
  'textNode___parent___internal___owner' |
  'textNode___parent___internal___type' |
  'textNode___children' |
  'textNode___children___id' |
  'textNode___children___parent___id' |
  'textNode___children___parent___children' |
  'textNode___children___children' |
  'textNode___children___children___id' |
  'textNode___children___children___children' |
  'textNode___children___internal___content' |
  'textNode___children___internal___contentDigest' |
  'textNode___children___internal___description' |
  'textNode___children___internal___fieldOwners' |
  'textNode___children___internal___ignoreType' |
  'textNode___children___internal___mediaType' |
  'textNode___children___internal___owner' |
  'textNode___children___internal___type' |
  'textNode___internal___content' |
  'textNode___internal___contentDigest' |
  'textNode___internal___description' |
  'textNode___internal___fieldOwners' |
  'textNode___internal___ignoreType' |
  'textNode___internal___mediaType' |
  'textNode___internal___owner' |
  'textNode___internal___type' |
  'textNode___childMarkdownRemark___id' |
  'textNode___childMarkdownRemark___frontmatter___title' |
  'textNode___childMarkdownRemark___excerpt' |
  'textNode___childMarkdownRemark___rawMarkdownBody' |
  'textNode___childMarkdownRemark___html' |
  'textNode___childMarkdownRemark___htmlAst' |
  'textNode___childMarkdownRemark___excerptAst' |
  'textNode___childMarkdownRemark___headings' |
  'textNode___childMarkdownRemark___headings___value' |
  'textNode___childMarkdownRemark___headings___depth' |
  'textNode___childMarkdownRemark___timeToRead' |
  'textNode___childMarkdownRemark___tableOfContents' |
  'textNode___childMarkdownRemark___wordCount___paragraphs' |
  'textNode___childMarkdownRemark___wordCount___sentences' |
  'textNode___childMarkdownRemark___wordCount___words' |
  'textNode___childMarkdownRemark___parent___id' |
  'textNode___childMarkdownRemark___parent___children' |
  'textNode___childMarkdownRemark___children' |
  'textNode___childMarkdownRemark___children___id' |
  'textNode___childMarkdownRemark___children___children' |
  'textNode___childMarkdownRemark___internal___content' |
  'textNode___childMarkdownRemark___internal___contentDigest' |
  'textNode___childMarkdownRemark___internal___description' |
  'textNode___childMarkdownRemark___internal___fieldOwners' |
  'textNode___childMarkdownRemark___internal___ignoreType' |
  'textNode___childMarkdownRemark___internal___mediaType' |
  'textNode___childMarkdownRemark___internal___owner' |
  'textNode___childMarkdownRemark___internal___type' |
  '_allTextLocales' |
  '_allTextLocales___locale' |
  '_allTextLocales___value' |
  '_allTextLocales___valueNode___id' |
  '_allTextLocales___valueNode___parent___id' |
  '_allTextLocales___valueNode___parent___children' |
  '_allTextLocales___valueNode___children' |
  '_allTextLocales___valueNode___children___id' |
  '_allTextLocales___valueNode___children___children' |
  '_allTextLocales___valueNode___internal___content' |
  '_allTextLocales___valueNode___internal___contentDigest' |
  '_allTextLocales___valueNode___internal___description' |
  '_allTextLocales___valueNode___internal___fieldOwners' |
  '_allTextLocales___valueNode___internal___ignoreType' |
  '_allTextLocales___valueNode___internal___mediaType' |
  '_allTextLocales___valueNode___internal___owner' |
  '_allTextLocales___valueNode___internal___type' |
  '_allTextLocales___valueNode___childMarkdownRemark___id' |
  '_allTextLocales___valueNode___childMarkdownRemark___excerpt' |
  '_allTextLocales___valueNode___childMarkdownRemark___rawMarkdownBody' |
  '_allTextLocales___valueNode___childMarkdownRemark___html' |
  '_allTextLocales___valueNode___childMarkdownRemark___htmlAst' |
  '_allTextLocales___valueNode___childMarkdownRemark___excerptAst' |
  '_allTextLocales___valueNode___childMarkdownRemark___headings' |
  '_allTextLocales___valueNode___childMarkdownRemark___timeToRead' |
  '_allTextLocales___valueNode___childMarkdownRemark___tableOfContents' |
  '_allTextLocales___valueNode___childMarkdownRemark___children' |
  'author' |
  '_allAuthorLocales' |
  '_allAuthorLocales___locale' |
  '_allAuthorLocales___value' |
  'company' |
  '_allCompanyLocales' |
  '_allCompanyLocales___locale' |
  '_allCompanyLocales___value' |
  'position' |
  'meta___createdAt' |
  'meta___updatedAt' |
  'meta___publishedAt' |
...
export type DatoCmsReferenceFilterInput = {
  text?: Maybe<StringQueryOperatorInput>;
  textNode?: Maybe<DatoCmsTextNodeFilterInput>;
  _allTextLocales?: Maybe<DatoCmsAllLocalesForDatoCmsReferenceTextFilterListInput>;
  author?: Maybe<StringQueryOperatorInput>;
  _allAuthorLocales?: Maybe<DatoCmsAllLocalesForDatoCmsReferenceAuthorFilterListInput>;
  company?: Maybe<StringQueryOperatorInput>;
  _allCompanyLocales?: Maybe<DatoCmsAllLocalesForDatoCmsReferenceCompanyFilterListInput>;
  position?: Maybe<IntQueryOperatorInput>;
  meta?: Maybe<DatoCmsMetaFieldFilterInput>;
  originalId?: Maybe<StringQueryOperatorInput>;
  locale?: Maybe<StringQueryOperatorInput>;
...
export type DatoCmsReferenceGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<DatoCmsReferenceEdge>;
  nodes: Array<DatoCmsReference>;
  pageInfo: PageInfo;
...
export type DatoCmsReferenceSortInput = {
  fields?: Maybe<Array<Maybe<DatoCmsReferenceFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type Query = {
  ...
  datoCmsReference?: Maybe<DatoCmsReference>;
  allDatoCmsReference: DatoCmsReferenceConnection;
  datoCmsAbout?: Maybe<DatoCmsAbout>;
  allDatoCmsAbout: DatoCmsAboutConnection;
  datoCmsBlog?: Maybe<DatoCmsBlog>;
  allDatoCmsBlog: DatoCmsBlogConnection;
...
export type QueryDatoCmsReferenceArgs = {
  text?: Maybe<StringQueryOperatorInput>;
  textNode?: Maybe<DatoCmsTextNodeFilterInput>;
  _allTextLocales?: Maybe<DatoCmsAllLocalesForDatoCmsReferenceTextFilterListInput>;
  author?: Maybe<StringQueryOperatorInput>;
...
export type QueryAllDatoCmsReferenceArgs = {
  filter?: Maybe<DatoCmsReferenceFilterInput>;
  sort?: Maybe<DatoCmsReferenceSortInput>;
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
};
...
export type QueryDatoCmsBlogArgs = {
  header?: Maybe<StringQueryOperatorInput>;
  _allHeaderLocales?: Maybe<DatoCmsAllLocalesForDatoCmsBlogHeaderFilterListInput>;
  meta?: Maybe<DatoCmsMetaFieldFilterInput>;
  originalId?: Maybe<StringQueryOperatorInput>;
...
export type QueryAllDatoCmsBlogArgs = {
  filter?: Maybe<DatoCmsBlogFilterInput>;
  sort?: Maybe<DatoCmsBlogSortInput>;
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
};
...
export type AboutQuery = { datoCmsAbout?: Maybe<(
    Pick<DatoCmsAbout, 'title'>
    & { contentNode?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'html'>> }>, image?: Maybe<{ fluid?: Maybe<GatsbyDatoCmsFluidFragment> }> }
  )> };

export type BlogPageQueryVariables = {};


export type BlogPageQuery = { allDatoCmsArticle: { edges: Array<{ node: (
      ...
      ) }> }, datoCmsBlog?: Maybe<Pick<DatoCmsBlog, 'header'>> };
...
export type IndexPageQuery = { allDatoCmsArticle: { edges: Array<{ node: (
        Pick<DatoCmsArticle, 'id' | 'title' | 'introduction' | 'slug'>
        & { coverImage?: Maybe<{ fluid?: Maybe<GatsbyDatoCmsFluidFragment> }>, meta?: Maybe<Pick<DatoCmsMetaField, 'firstPublishedAt'>> }
      ) }> }, allDatoCmsReference: { edges: Array<{ node: Pick<DatoCmsReference, 'id' | 'text' | 'author' | 'company'> }> }, datoCmsHome?: Maybe<(
